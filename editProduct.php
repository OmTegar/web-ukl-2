...
if (isset($_POST['update'])) {
	...
	if ($filename == null) {
		...
		$result = "UPDATE products SET P_Name='$productName', Category='$category', Stock='$stock', Price='$price', Discount='$discount', Width='$width', Weight='$weight', Height='$height' WHERE P_Id='$id'";
		...
		$result = "UPDATE products SET P_Name='$productName', Category='$category', Stock='$stock', Price='$price', Discount='$discount', Width='$width', Weight='$weight', Height='$height', Image='$target_file' WHERE P_Id='$id'";
		$sql = mysqli_query($dbhandle, $result);
	}
							...
							<form enctype="multipart/form-data" role="form" method="POST" action="#">
								<fieldset>
									...
									<label class="btn btn-default" for="my-file-selector">
										<input id="my-file-selector" name="image" id="image" type="file"
											style="display:none;" />
										Change Photo
									</label>
